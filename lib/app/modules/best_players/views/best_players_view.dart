...
import 'package:game_app/app/data/services/best_player_services/best_player_services.dart';
import 'package:game_app/app/data/services/constants_service/constants_service.dart';

import 'package:get/get.dart';

import '../../../constants/cards/best_players_card.dart';
import '../../../constants/others/app_bar.dart';
import '../../../constants/others/constants.dart';
import '../../../constants/others/widgets.dart';
import '../../../data/models/best_players_model/best_player_model.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: MyAppBar(
        ...
        icon: IconButton(
          onPressed: () {
            ConstantsService().getConsts().then((value) {
              showBestPlayerPrice(
                context,
                'bestPlayers'.tr,
                value.bestPlayersText!,
              );
            });
          },
          icon: const Icon(
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<List<BestPlayersModel>>(
              future: BestPlayersServices().getBestPlayers(),
          ...
          child: Opacity(
            ...
            child: AlertDialog(
              ...
              title: Text(
                ...
                style: const TextStyle(color: Colors.white, fontSize: 26, fontFamily: josefinSansBold),
              ),
              content: Padding(

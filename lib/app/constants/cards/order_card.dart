          ...
          Expanded(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                ...
                errorWidget: (context, url, error) => Text('noImage'.tr),
              ),
            ),
          ),
          Expanded(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.find<PubgUcController>().removeCart(id);
                          final double b = double.parse(price);
                          Get.find<PubgUcController>().finalPRice.value -= b * count;
                          if (Get.find<PubgUcController>().finalPRice.value == 0) {
                            Get.back();
                          }
                        },
                        child: const Padding(
